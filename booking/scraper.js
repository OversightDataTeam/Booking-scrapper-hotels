...
async function scrapeAllArrondissements() {
  console.log(`\n🔄 Starting scraping for all arrondissements sequentially`);
  
  for (const arrondissement of arrondissements) {
    console.log(`🏙️ Processing ${arrondissement}e arrondissement...`);
    ...
    try {
      ...
      console.log(`✅ Completed scraping for ${arrondissement}e arrondissement`);
    } catch (error) {
      console.error(`❌ Error scraping ${arrondissement}e arrondissement:`, error);
    }
  }
  
  console.log(`\n✅ Completed scraping for all arrondissements`);
}
